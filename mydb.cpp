...
{
    qDebug() << "in init()";
    db = QSqlDatabase::addDatabase("QSQLITE", "Data");  //adding sqlite database
    db.setDatabaseName("G:/db_movie_ticket_booking.sqlite");   //locating sqlite database

    if(QFile::exists("G:/db_movie_ticket_booking.sqlite"))
